...
impl USART {
    ...
    #[inline(always)]
    pub fn baud_usartfp_mode(&self) -> &BAUD_USARTFP_MODE {
        unsafe { &*(((self as *const Self) as *const u8).add(12usize) as *const BAUD_USARTFP_MODE) }
    }
    #[doc = "0x0c - USART Baud Rate"]
    #[inline(always)]
    pub fn baud_fracfp_mode(&self) -> &BAUD_FRACFP_MODE {
        unsafe { &*(((self as *const Self) as *const u8).add(12usize) as *const BAUD_FRACFP_MODE) }
    }
    #[doc = "0x0c - USART Baud Rate"]
    #[inline(always)]
    pub fn baud_frac_mode(&self) -> &BAUD_FRAC_MODE {
        unsafe { &*(((self as *const Self) as *const u8).add(12usize) as *const BAUD_FRAC_MODE) }
    }
    #[doc = "0x0c - USART Baud Rate"]
    #[inline(always)]
    pub fn baud(&self) -> &BAUD {
        unsafe { &*(((self as *const Self) as *const u8).add(12usize) as *const BAUD) }
    }
}
